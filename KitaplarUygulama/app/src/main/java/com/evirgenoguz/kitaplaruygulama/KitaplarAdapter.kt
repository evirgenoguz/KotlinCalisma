...
import com.evirgenoguz.kitaplaruygulama.databinding.KitapCardBinding
import com.evirgenoguz.kitaplaruygulama.model.Kitap
import com.squareup.picasso.Picasso

class KitaplarAdapter(private var kitaplarList: ArrayList<Kitap>): RecyclerView.Adapter<KitaplarAdapter.KitapCardDesign>() {

    class KitapCardDesign(val kitapCardBinding: KitapCardBinding): RecyclerView.ViewHolder(kitapCardBinding.root){
