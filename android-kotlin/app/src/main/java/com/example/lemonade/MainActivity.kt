...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        lemonImage!!.setOnClickListener {
            ...
            clickLemonImage() //buraya tıklanınca clickLemonImage muhabbeti çalışacak onu içi doldurulmalı


        }
        lemonImage!!.setOnLongClickListener {
            // TODO: replace 'false' with a call to the function that shows the squeeze count
            showSnackbar() //snackbar göstermek için kullanılacak method
        }
    }
    ...
    private fun clickLemonImage() {
        ...
        if (lemonadeState == SELECT){
            ...
            lemonSize = lemonTree.pick() //lemon size rastgele bir sayı atandı 2 4 arasında bu sıkma sayısı
